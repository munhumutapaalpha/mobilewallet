...
NRS.onSiteBuildDone().then(() => {
    NRS = (function (NRS, $, undefined) {
        ...
        NRS.setup.currencies = function () {
            ...
            var options = {
                "id": sidebarId,
                "titleHTML": '<i class="fa fa-university"></i><span data-i18n="mutapa_bank">Mutapa Bank</span>',
                "page": 'currencies',
                "desiredPosition": 40,
        ...
        NRS.forms.issueCurrency = function ($modal) {
            ...
            if (data.minReservePerUnitMTA) {
                data.minReservePerUnitMTA = NRS.convertToMTA(data.minReservePerUnitMTA);
                data.minReservePerUnitMTA = NRS.convertToQNTf(data.minReservePerUnitMTA, data.decimals);
            }
