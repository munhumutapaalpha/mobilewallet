...
var NRS = (function (NRS, $) {
    ...
    var CHAIN_DISPLAY_TO_LOGIC_MAPPING = { "DFINANCE": "DFINANCE" };
    var CHAIN_LOGIC_TO_DISPLAY_MAPPING = { "DFINANCE": "DFINANCE" };
    var CHAIN_DESCRIPTION = [];
    var PERMISSION_POLICY_BETA_CHAIN = "BETA_CHAIN";
    ...
    NRS.isActivePermissionPolicyBetaChain = function() {
        return NRS.getActiveChainPermissionPolicy() === PERMISSION_POLICY_BETA_CHAIN;
    };
